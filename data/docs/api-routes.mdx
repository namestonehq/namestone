...
To use our API, you'll need an API key for authentication. Fill out the [form](https://namestone.com/try-namestone) to receive an API key via email, or request one by emailing [api@namestone.com](mailto:api@namestone.com).
