...
![](https://imagedelivery.net/UJ5oN2ajUBrk2SVxlns2Aw/4d660d93-51cb-41a8-f269-eb506a71fa00/public)

For Type, select '"TXT".

For Name, type an asterisk: \*

For Content Field, copy and paste the following record:

```
ENS1 0x84c5AdB77dd9f362A1a3480009992d8d47325dc3 0x1E0B906b2350aABE06e8051670b083CCe03287FD https://gateway.namestone.xyz/namestone-pg
```

Each segment in the content field should be separated with a space.

![](https://imagedelivery.net/UJ5oN2ajUBrk2SVxlns2Aw/134dd536-f50b-4b7c-f04f-2dd65ac86600/public)
...
Now your domain name is ready to issue ENS subnames. Email [alex@namestone.xyz](mailto:alex@namestone.xyz) to get your API key and start issuing subnames.
