...
This guide walks through how to enable gasless ENS subdomains on your DNS domain (e.g., name.testbrand.xyz). No onchain transaction is required.
...
Once DNSSEC setup is complete and you've added the correct TXT record, your domain name is ready to issue ENS subnames! Email [alex@namestone.com](mailto:alex@namestone.com) to get your free API key and start issuing subnames.
