...
> **Service update:** This endpoint no longer accepts requests. NameStone is shutting down August 3, 2026, and is no longer issuing new API keys.

Previously, this POST route enabled a domain programmatically and returned an API key.
