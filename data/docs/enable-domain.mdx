...
This POST route is used to enable a new domain for namestone programatically. It returns an api key.  
In order to use it you must sign a message from [get-siwe-message](./get-siwe-message)  
and switch your domains resolver to ours: `0xd17347fA0a6eeC89a226c96a9ae354F785e94241`
