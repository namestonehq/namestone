          ...
          <>
            ...
            <div className="items-center hidden space-x-6 md:space-x-8 lg:flex">
              ...
              <Link
                ...
                href="/admin"
              >
                <button className="z-20 px-4 py-2 text-sm font-bold bg-orange-500 rounded-lg cursor-pointer hover:bg-orange-700 text-brownblack-700 active:bg-orange-800">
                  Admin Login
                </button>
              </Link>
            </div>
