  ...
  return (
    <div className="px-4 py-4">
      ...
      <p className="mb-4">
        ...
        shared and/or collect in NameStone. This policy is not applicable to any
        information collected offline or via channels other than this website.
      </p>
      <h2 className="mb-1 text-sm font-bold">Consent</h2>
      <p className="mb-4">
        By using our website, you hereby consent to our Privacy Policy and agree
        to its terms.
      </p>
      <h2 className="mb-1 text-sm font-bold">Information we collect</h2>
      <p className="mb-4">
      ...
      <h2 className="mb-1 text-sm font-bold">How we use your information</h2>
      <p className="mb-4">
      ...
      <h2 className="mb-1 text-sm font-bold">Log Files</h2>
      <p className="mb-4">
        NameStone follows a standard procedure of using log files. These files
      ...
      <h2 className="mb-1 text-sm font-bold">Cookies and Web Beacons</h2>
      <p className="mb-4">
        Like any other website, NameStone uses &apos;cookies&apos;. These
      ...
      <p className="mb-4">
        ...
        advertising partners of NameStone.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        Note that NameStone has no access to or control over these cookies that
        are used by third-party advertisers.
      </p>
      <h2 className="mb-1 text-sm font-bold">Third Party Privacy Policies</h2>
      <p className="mb-4">
        NameStone&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <h2 className="mb-1 text-sm font-bold">GDPR Data Protection Rights</h2>
      <p className="mb-4">
      ...
      <h2 className="mb-1 text-sm font-bold">Children&apos;s Information</h2>
      <p className="mb-4">
