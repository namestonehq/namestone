...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className="w-full px-6 overflow-hidden text-center bg-orange-20 md:px-20 md:text-left">
        <div className="flex flex-wrap justify-center md:justify-between 2xl:justify-around mt-24 md:mt-[240px]  mb-8 z-10 ">
          <div className="z-20 flex flex-col items-center md:items-start">
            <span className="max-w-lg text-md sm:text-lg md:text-xl font-bold md:leading-tight text-brownblack-700">
              Issue gasless ENS subdomains
            </span>
            <span className="max-w-lg text-sm md:text-base mt-3 text-brownblack-700">
      ...
      <div className="w-full px-6 pb-20 text-center bg-white md:px-20">
        ...
        <div className="flex flex-wrap items-center gap-10 mt-16">
          <div className="flex flex-col justify-start flex-1 text-left min-w-[280px]">
            <div className="leading-tight text-md md:text-lg font-bold text-brownblack-700">
      ...
      {/*  Call section */}
      <div className="flex flex-col items-center justify-center w-full px-6 md:px-16 py-16 text-center bg-orange-20">
        <div className="text-md md:text-lg font-bold  brownblack-700">
          Ready to get started?{" "}
        </div>
        <div className="text:sm md:text-base mt-3 text-center brownblack-700 max-w-xl ">
      ...
      <div className="w-full px-6 pb-20 text-center bg-white md:px-20 ">
        ...
        <div className="px-6 py-10 mt-16 rounded-xl bg-brownblack-20 ">
          <div className="flex flex-col items-center text-md md:text-lg font-bold text-brownblack-700">
            Gasless User Benefits
          </div>
          <div className="text-sm md:text-base text-center mt-3 text-brownblack-700">
          ...
          <div className="flex flex-row flex-wrap justify-center pt-12 md:gap-4">
            {gaslessData.map((data) => (
              ...
              >
                ...
                <div className="font-bold  mt-4 md:mt-7 text-sm md:text-base text-brownblack-700">
                  {data.text}
                </div>
              </div>
            ))}
      ...
      <div className="flex flex-col items-center justify-start w-full px-6 py-16 bg-orange-20">
        <div className="text-md md:text-lg font-bold  brownblack-700 text-center">
          Hundreds of integrations <br /> powered by ENS
        </div>
        <div className="flex flex-wrap items-center justify-around w-full gap-4 md:px-20 mt-16">
      ...
      <div className="relative w-full pt-16 text-center bg-white">
        <div className="flex text-md md:text-lg font-bold text-brownblack-700 flex-col items-center">
      ...
      {/* Final Call section */}
      <div className="flex flex-col items-center justify-center w-full px-6 md:px-16 py-16 text-center bg-brownblack-700">
        <div className="text-md md:text-lg font-bold text-white mt-16">
          Ready to get started?{" "}
        </div>
        <div className="text-sm md:text-base mt-3 text-center text-white max-w-xl ">
          Our team is standing by to answer your questions and find the right
          solution for you
        </div>
        <div className="flex flex-wrap justify-center gap-4 mt-10 mb-16">
